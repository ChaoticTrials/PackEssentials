...
import de.melanx.modpackslave.items.CompressedBlockItem;
...
public class CompressedBlock extends ModpackBlockBase {
    ...
    public CompressedBlock(ModX mod, @Nullable Item.Properties itemProperties, Block baseBlock, int compression, Modpack... modpacks) {
        ...
        this.tooltip = Component.translatable("modpackslave.block.compressed.tooltip", (int) Math.pow(COMPRESSION_SIZE, this.compression), this.baseBlock.getName()).withStyle(ChatFormatting.GRAY);
    ...
    public MutableComponent getName() {
        return Component.translatable(ModpackSlave.getInstance().modid + ".block.compressed_" + this.compression, this.baseBlock.getName());
    }
